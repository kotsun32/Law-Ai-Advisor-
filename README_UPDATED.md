...
```json
{
  "question": "How do I file a complaint against my landlord?"
}
```
...
{
  "question": "How do I file a complaint against my landlord?",
  "answer": "To file a complaint against your landlord...",
  "documents_used": 3,
  "status": "success",
  "processing_time": 2.5
}
...
#### GET /api/examples
Sample questions for each complexity tier
...
├── vector_store.py        # Vector store creation (legacy)
